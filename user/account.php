  ...
  <head>
    ...
    <?php
      ...
      if(!isset($_SESSION['logged-in'])) {
        $_SESSION['redirecting-location'] = "../user/account.php";
        ...
        $db_data = mysqli_query($con,"SELECT Email FROM Register WHERE Public_Id = '$UserId';");
        $tabledata = mysqli_fetch_row($db_data);
        $email = $tabledata[0];
        $db_data = mysqli_query($con,"SELECT Username FROM Users WHERE Public_Id = '$UserId';");
        $tabledata = mysqli_fetch_row($db_data);
          ...
          <div class="range range-50 range-md-justify range-sm-middle">
            ...
            <div class="cell-sm-6 cell-md-5 wow fadeInUp" data-wow-delay=".2s">
              ...
              <div style="display: flex; align-items: center;">
                <img src="../img/icons/id.png" style="height: 50px;padding-right: 10px;"><h3><?php echo "$UserId"; ?></h3>
              </div><br>
              <div style="display: flex; align-items: center;">
